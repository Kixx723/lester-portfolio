    ...
    <main className="md:flex mt-[10%] gap-20 justify-center">
      ...
      <div className="flex flex-col gap-1 text-center mt-16">
        ...
        <div className="flex gap-3 mt-3 justify-center">
          <button className="border-2 border-black p-3 rounded-3xl text-sm font-bold hover:bg-black hover:text-white">Download CV</button>
          <div className="flex gap-2 mt-2">
            <img src={LINKEDIN} alt="linked-in" className="h-8 cursor-pointer"/>
